...
public class Cviewbill {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Cviewbill window = new Cviewbill();
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(159, 0, 134, 42);
		...
		try {
			...
			java.sql.PreparedStatement st = con.prepareStatement("select * from billing");
